//package com.example.distrans.database;
//
...
//		
//		Log.d("===DATABASE===", "Start to create tables");
...
//		onCreate(db);
	...
	public List<Trasee> getTrasee() {
		SQLiteDatabase db = this.getReadableDatabase();
		List<Trasee> traseeList = new ArrayList<Trasee>();
		String selectQuery = "SELECT * FROM " + TABLE_TRASEU;// + " WHERE nrc=" + tipAuto + "";
		System.out.println(selectQuery);
		Cursor cursor = db.rawQuery(selectQuery, null);
		if(cursor.moveToFirst()) {
			do {
...
//	Get categoria auto - groups
	public List<CategorieAuto> getCategorieAuto() {

      
		SQLiteDatabase db = this.getReadableDatabase();
		List<CategorieAuto> categorieAutoList = new ArrayList<CategorieAuto>();
		String selectQuery = "SELECT tipAuto FROM " + TABLE_CATEGORIEAUTO;
		System.out.println(selectQuery);
		Cursor cursor = db.rawQuery(selectQuery, null);
		if(cursor.moveToFirst()) {
			do {
				CategorieAuto categorieAuto = new CategorieAuto();
//				categorieAuto.setNrc(Integer.parseInt(cursor.getString(0)));
				categorieAuto.setTipAuto(cursor.getString(0));
				categorieAutoList.add(categorieAuto);
			} while (cursor.moveToNext());
		}
		return categorieAutoList;
	}
...
////		SQLiteDatabase db = this.getReadableDatabase();
//		String selectQuery = "SELECT * FROM " + TABLE_CATEGORIEAUTO;
//		System.out.println(selectQuery);
//		return db.rawQuery(selectQuery, null);
//	}
//	
//	public Cursor fetchChildren(String categorieAuto) {
//		String query = "SELECT * FROM " + TABLE_TRASEU;
